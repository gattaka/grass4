...
ALTER TABLE CAMPGAME ALTER COLUMN   id BIGINT GENERATED BY DEFAULT AS IDENTITY;
ALTER TABLE CAMPGAME
    ALTER COLUMN ID RESTART WITH (SELECT MAX(ID) + 1 FROM CAMPGAME);

ALTER TABLE QUOTE ALTER COLUMN id BIGINT GENERATED BY DEFAULT AS IDENTITY;
ALTER TABLE QUOTE
    ALTER COLUMN ID RESTART WITH (SELECT MAX(ID) + 1 FROM QUOTE);

ALTER TABLE NODE ALTER COLUMN id BIGINT GENERATED BY DEFAULT AS IDENTITY;
ALTER TABLE NODE
    ALTER COLUMN ID RESTART WITH (SELECT MAX(ID) + 1 FROM NODE);
