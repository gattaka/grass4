...
public class ContextImpl implements Context {
     ...
     */
    private final Set<String> cssResources = new LinkedHashSet<>();
    private final Set<String> jsResources = new LinkedHashSet<>();
    private final Set<String> jsCodes = new LinkedHashSet<>();
    ...
    public void setHeaderLevel(int level) {
        ...
        if (this.textLevel != 0) out.append(END_DIV);
    ...
    public String getOutput() {
        ...
        return (this.textLevel != 0) ? (out + END_DIV) : out.toString();
    }
