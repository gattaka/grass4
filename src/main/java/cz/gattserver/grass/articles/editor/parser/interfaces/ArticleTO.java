...
public record ArticleTO(Long id, Long contentNodeId, String name, Long parentId, String parentName, LocalDateTime creationDate,
                        LocalDateTime lastModificationDate, Long authorId, String authorName, boolean publicated,
                        boolean draft, Set<ContentTagTO> contentTags, String outputHTML, String text, String searchableOutput,
    ...
    public ArticleTO(Long id, Long contentNodeId, String name, Long parentId, String parentName,
                     ...
                     boolean publicated, boolean draft, String outputHTML, String text, String searchableOutput,
                     String attachmentsDirId) {
        this(id, contentNodeId, name, parentId, parentName, creationDate, lastModificationDate, authorId, authorName,
                publicated, draft, new LinkedHashSet<>(), outputHTML, text, searchableOutput, attachmentsDirId,
