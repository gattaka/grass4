...
public class EditorButtonResourcesTOBuilder {
    ...
    private DownloadHandler imageResource;
    ...
    public EditorButtonResourcesTOBuilder(String tag, String tagFamily, String description, String prefix,
                                          String suffix, DownloadHandler imageResource) {
        this.tag = tag;
    ...
    public EditorButtonResourcesTO build() {
        ...
        if (StringUtils.isBlank(dsc) && imageResource == null) dsc = tag;
     ...
     */
    public EditorButtonResourcesTOBuilder setImageResource(DownloadHandler imageResource) {
        this.imageResource = imageResource;
        return this;
    }
    ...
    public EditorButtonResourcesTOBuilder setImageAsThemeResource(String imagePath) {
        this.imageResource =
                DownloadHandler.forClassResource(getClass(), "/static/VAADIN/articles/" + imagePath, "icon");
        return this;
    }
