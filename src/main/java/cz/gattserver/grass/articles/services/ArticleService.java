...
public interface ArticleService {
     ...
     * Uloží nový článek
     *
     * @param payload  obsahové informace článku
     * @param nodeId   id kategorie, do které je článek ukládán
     * @param authorId id uživatele, který článek vytvořil
     ...
     * Upraví článek
     *
     * @param articleId id upravovaného článku
     * @param payload   obsahové informace článku
     */
    void modifyArticle(long articleId, ArticlePayloadTO payload);
     ...
     * @param nodeId    id kategorie, do které je článek ukládán
     * @param authorId  id uživatele, který článek vytvořil
     * @param asPreview <code>true</code>, pokud je koncept vytvářen za účelem náhledu
     ...
     * @param nodeId          id kategorie, do které je článek ukládán
     * @param authorId        id uživatele, který článek vytvořil
     * @param originArticleId id článku, k jehož úpravě je ukládán tento koncept
     * @param asPreview       <code>true</code>, pokud je koncept vytvářen za účelem náhledu
     * @return id uloženého konceptu, pokud se operace zdařila
     */
    long saveDraftOfExistingArticle(ArticlePayloadTO payload, long nodeId, long authorId, long originArticleId,
                                    boolean asPreview);

    /**
     * Upraví koncept článku z vytváření nového článku
     *
     * @param drafId    id upravovaného konceptu
     * @param payload   obsahové informace článku
     * @param asPreview <code>true</code>, pokud je koncept upravován za účelem
     *                  náhledu
     */
     ...
     *                        náhledu
     */
    void modifyDraftOfExistingArticle(long drafId, ArticlePayloadTO payload, long originArticleId, boolean asPreview);
     ...
     *
     * @param attachmentsDirId id úložiště
     * @param in               vstupní proud dat
     * @param name             cesta k souboru z aktuálního adresáře pod kterou bude soubor
     *                         uložen
