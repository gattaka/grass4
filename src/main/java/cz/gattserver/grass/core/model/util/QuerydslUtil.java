...
public final class QuerydslUtil {
     ...
     *
     * @param <T>      typ {@link JPAQuery}
     * @param pageable definice stránkování
     ...
     * @return
     */
    public static <T> JPQLQuery<T> applyPagination(Pageable pageable, JPQLQuery<T> query) {
        if (pageable == null) return query;
        query.offset(pageable.getOffset());
        query.limit(pageable.getPageSize());
        if (pageable.getSort() != null)
    ...
    public static OrderSpecifier<String>[] transformOrdering(Object[] sortPropertyIds, boolean[] asc) {
        @SuppressWarnings("unchecked") OrderSpecifier<String>[] specifiers = new OrderSpecifier[sortPropertyIds.length];
    ...
    public static OrderSpecifier<String>[] transformOrdering(List<QuerySortOrder> sortProperties,
        ...
        @SuppressWarnings("unchecked") OrderSpecifier<String>[] specifiers = new OrderSpecifier[sortProperties.size()];
