...
public interface ContentNodeService {
     ...
     *
     * @param contentModuleId identifikátor modulu obsahů
     * @param contentId       id obsahu, který byl vytvořen modulem obsahů a ke kterému má
     *                        být vytvořen {@link ContentNode} záznam
     * @param name            jméno obsahu
     * @param tags            řetězec tagů, který se má společně s obsahem uložit
     * @param hidden          <code>true</code>, pokud je obsah publikován
     * @param nodeId          id kategorie do které se vkládá
     * @param author          id uživatele, který obsah vytvořil
     * @param draft           <code>true</code>, pokud se jedná se o rozpracovaný obsah
     * @param date            předdefinované datum vytvoření nebo <code>null</code>, pokud
     *                        je datem vytvoření aktuální čas
     * @param draftSourceId   id existujícího zdrojového obsahu (vytvořeného modulem
     *                        obsahů), od kterého je draft nebo <code>null</code>
     * @return id {@link ContentNode} záznamu, který byl k obsahu vytvořen
     */
    long save(String contentModuleId, long contentId, String name, Collection<String> tags, boolean hidden, long nodeId,
              long author, boolean draft, LocalDateTime date, Long draftSourceId);

    /**
     * Získá contentNodeDTO dle jeho id
     *
     * @param id identifikátor obsahu
     * @return obsah
     */
     ...
     *
     * @param contentNodeId uzel obsahu, který patří k tomuto obsahu
     * @param name          název obsahu
     * @param hidden        je obsah publikovaný
     */
     ...
     * @param tags          řetězec tagů, který se má společně s obsahem uložit
     * @param hidden        <code>true</code>, pokud je obsah publikován
     * @param creationDate  vnucené datum vytvoření obsahu, které přepíše původní
     *                      automatické datum
     */
    void modify(long contentNodeId, String name, Collection<String> tags, boolean hidden, LocalDateTime creationDate);

    /**
     * Smaže obsah dle id obecného uzlu obsahu
     *
     * @param contentNodeId id obecného uzlu obsahu
     */
     ...
     *
     * @param contentModuleId identifikátor modulu obsahů
     * @param contentId       id koncového obsahu v rámci modulu obsahů
     */
     ...
     *
     * @param nodeId        id cílové kategorie
     * @param contentNodeId id obsahu k přesunutí
     */
     ...
     *
     * @param tagId id tagu, dle kterého bude výběr omezen
     ...
     *
     * @param userId id uživatele, dle kterého bude výběr omezen
     ...
     *
     * @param userId id uživatele, z jehož oblíbených budou obsahy čteny
     * @param offset offset
     * @param limit  limit
     ...
     * @param explicitAccess explicitní přístup
     * @return počet obsahů dle kategorie
     */
    int getCountByFilter(ContentNodeFilterTO filter, boolean explicitAccess);
     ...
     * @return list nalezených obsahů dle stránkování a omezení
     */
    List<ContentNodeOverviewTO> getByFilter(ContentNodeFilterTO filter, boolean explicitAccess, int offset, int limit);
