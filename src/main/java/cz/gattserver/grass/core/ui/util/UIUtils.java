...
public class UIUtils {
    ...
    public static final String ON_BEFORE_UNLOAD_WARNING =
            "Opravdu si přejete odejít? Rozpracované změny nemusí být uloženy.";
    ...
    public static boolean isMobileDevice() {
        ...
        if (ecd != null && !ecd.isTouchDevice()) return false;
    ...
    private static String getClientIp(HttpServletRequest request) {
        ...
        if (StringUtils.isBlank(remoteAddr)) remoteAddr = request.getRemoteAddr();
        return remoteAddr;
    }
