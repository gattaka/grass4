...
public class BeerDialog extends DrinkDialog<BeerTO> {

    @Serial
    private static final long serialVersionUID = -5432598644241934027L;

    public BeerDialog(BeerTO to, Consumer<BeerTO> onSave) {
        super(to, onSave);
    }

    public BeerDialog(Consumer<BeerTO> onSave) {
        super(onSave);
    }
