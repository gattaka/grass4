...
public class RumTab extends DrinksTab<RumTO, RumOverviewTO> {
    ...
    protected void configureGrid(Grid<RumOverviewTO> grid, final RumOverviewTO filterTO) {
        ...
        Column<RumOverviewTO> yearsColumn =
                grid.addColumn(RumOverviewTO::getYears).setHeader("Stáří (roky)").setWidth("90px").setFlexGrow(0)
                        .setSortProperty("years");
        Column<RumOverviewTO> rumTypeColumn =
                grid.addColumn(new TextRenderer<>(to -> to.getRumType().getCaption())).setHeader("Typ rumu")
                        .setWidth("100px").setFlexGrow(0).setSortProperty("rumType");
