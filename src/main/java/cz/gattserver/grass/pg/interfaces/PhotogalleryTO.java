...
public record PhotogalleryTO(Long id, Long contentId, String name, Long parentId, String parentName, LocalDateTime creationDate,
                             LocalDateTime lastModificationDate, Long authorId, String authorName, String photogalleryPath,
                             boolean publicated, boolean draft, Set<ContentTagTO> contentTags) implements ContentNodeTO2 {
    ...
    public PhotogalleryTO(Long id, Long contentId, String name, Long parentId, String parentName,
        ...
        this(id, contentId, name, parentId, parentName, creationDate, lastModificationDate, authorId, authorName,
                photogalleryPath, publicated, draft, new HashSet<>());
    }
