...
public interface PGService {
     ...
     *
     * @param photogalleryId id původní galerie
     * @param payloadTO      obsah galerie
     ...
     * @param authorId  uživatel, který galerii vytvořil
     * @param date      datum vytvoření galerie, může být i <code>null</code>, pak
     *                  bude použito aktuální datum
     */
     ...
     *
     * @param id       idetifikátor galerie
     * @param fileName jméno fotografie
     ...
     *
     * @param selected   vybrané soubory
     ...
     *
     * @param galleryDir adresář galerie
     * @param file       jméno souboru, který má být předáván
     * @return soubor obrázku
     * @throws IllegalStateException    pokud neexistuje kořenový adresář galerií -- chyba nastavení
     *                                  modulu PG
     * @throws IllegalArgumentException pokud předaný adresář podtéká kořen modulu PG
     * @throws IllegalArgumentException pokud předaný soubor podtéká kořen galerie
     */
     ...
     * @throws IllegalArgumentException pokud předaný adresář podtéká kořen modulu PG
     */
    List<PhotogalleryViewItemTO> getItems(String galleryDir);
     ...
     *
     * @param galleryDir adresář galerie
     * @param skip       počet přeskočených položek (stránkování)
     * @param limit      počet položek (stránkování)
     * @return položky
     * @throws IOException              pokud se nezdařilo číst přehled adresáře galerie
     * @throws IllegalStateException    pokud neexistuje kořenový adresář galerií -- chyba nastavení
     *                                  modulu PG
     ...
     * @throws IllegalStateException    pokud neexistuje kořenový adresář galerií -- chyba nastavení
     *                                  modulu PG
     * @throws IllegalArgumentException pokud předaný adresář podtéká kořen modulu PG adresář galerie
     */
