...
public class MedicUtilTest {
	...
	public void test() throws ParseException {
		...
		ScheduledVisitOverviewTO to = new ScheduledVisitOverviewTO();

		String dateStart = "21.12.2012 09:29:58";
		String dateStop = "02.01.2013 10:31:48";

		to.setDateTime(LocalDateTime.parse(dateStop, formatter));
		assertFalse(MedicUtil.fromNowAfter7Days(to.getDateTime(), LocalDateTime.parse(dateStart, formatter)));

		dateStart = "26.12.2012 09:29:58";
		dateStop = "02.01.2013 10:31:48";

		to.setDateTime(LocalDateTime.parse(dateStop, formatter));
		assertTrue(MedicUtil.fromNowAfter7Days(to.getDateTime(), LocalDateTime.parse(dateStart, formatter)));
